...
function expandArticleBody() {
  // your code here
  var articleHeads = document.querySelectorAll(".article_head");
  articleHeads.forEach(function (article) {
    var expandBtn = article.querySelector(".expand_button");
    expandBtn.addEventListener("click", function (event) {
      var articleBody = article.parentElement.querySelector(".article_body");
...
function highlightArticle() {
  ...
  articles.forEach(function (article) {
    var highlightBtn = article.querySelector(".highlightBtn");
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "52928" + '/');
